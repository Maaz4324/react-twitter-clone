...
import maazuser from "../images/Mlogo.png";
import ActivityFeed from "./ActivityFeed";
import { feedDatas } from "../assets/FeedData";
import logo from "../images/twitter_logo.svg";

function Tweet() {
  return (
    <div className="tweet_container">
      <div className="tweet_top">
        <div className="tweet_user user_tweet_top">
          <img src={maazuser} alt="" />
        </div>
        <h2>Latest Tweets</h2>
        <div className="logo logo_tweet_top">
          <svg
            viewBox="0 0 24 24"
            aria-hidden="true"
      ...
      <div className="tweet_bottom">
        {feedDatas.map((feedData) => (
          <div className="tweet_feed_container">
            <div className="feed_user_logo">
              <img src={feedData.userImg} alt="" />
            </div>
            <div className="feed_contents">
              <div className="feed_user_name">
                <h5>{feedData.userName}</h5>
                <p>{feedData.userId}</p>
              </div>
              <div className="feed_txt">
                <p>{feedData.feedTxt}</p>
              </div>
